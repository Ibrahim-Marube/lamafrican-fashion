...
const categories = [
  { id: 1, name: 'Accessories - Sun Hats', slug: 'sun-hats', images: ['/images/products/sun-hats/sun1.JPG', '/images/products/sun-hats/sun2.JPG', '/images/products/sun-hats/sun3.JPG', '/images/products/sun-hats/sun4.JPG', '/images/products/sun-hats/sun5.JPG'] },
  { id: 2, name: 'African Men Shirts', slug: 'men-shirts', images: Array.from({ length: 9 }, (_, i) => `/images/products/men-shirts/men-shirt-${i + 1}.jpg`) },
  { id: 3, name: 'Ankara Bomber Jackets', slug: 'bomber-jackets', images: Array.from({ length: 9 }, (_, i) => `/images/products/bomber-jackets/bomber${i + 1}.JPG`) },
  ...
  { id: 5, name: 'Ankara Ladies Tops', slug: 'ladies-tops', images: Array.from({ length: 9 }, (_, i) => `/images/products/ladies-tops/top${i + 1}.jpg`) },
  ...
  { id: 12, name: 'Bridesmaids Dresses', slug: 'bridesmaids', images: Array.from({ length: 7 }, (_, i) => `/images/products/bridesmaids/bridesmaid${i + 1}.jpg`) },
